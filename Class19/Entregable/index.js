        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        axios_1['default'].get('https://goquotes-api.herokuapp.com/api/v1/random?count=10'),
                    ];
                case 1:
                    return [4 /*yield*/, _a.sent().data.quotes];
                case 2:
                    quotes = _a.sent();
                    messages = quotes.map(function (messages) {
...
var addMessages = function () {
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, newMessages()];
                case 1:
                    messages = _a.sent();
                    return [4 /*yield*/, newUsers()];
                case 2:
                    users = _a.sent();
                    chat = users.map(function (user, idx) {
                        return {
