...
import { FireCart } from '../models/DAOs/Firebase/cart';
/**
 *
 ...
 */
class CartApi {
    private products: FSCart | SQLCart | MongoCart | FireCart; // Ir cambiando tipo de clase cuando se agreguen más persistencias
    constructor() {
