...
dotenv.config();
exports.atlasURI = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@project.lofof.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
const botData = {
    ...
    password: (0, passport_1.createHash)('test123'),
    name: `Manson`,
    surname: `Bot`,
    alias: `Welcome Bot`,
    age: "27/12/2000",
